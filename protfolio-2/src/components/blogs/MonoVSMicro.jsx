    ...
    <div className="md:mt-5 my-3 md:max-w-3xl md:ml-6">
          ...
          <ol className="list-disc ml-5">
            <li>
              <p className="lg:text-lg text-neutral-400">
                ...
                Developers can focus on one unified codebase, reducing the need
          ...
          <ol className="list-disc ml-5">
            <li>
              <p className="lg:text-lg text-neutral-400">
                ...
                more efficient since there’s no need to manage multiple services
                and deployments. The project can be built, deployed, and scaled
                as one unit.
              </p>
            </li>
          </ol>
          ...
          <ol className="list-disc ml-5">
            <li>
              <p className="lg:text-lg text-neutral-400">
                ...
                <strong className="text-neutral-300">
                  ensuring high availability and fault tolerance in the system.
                </strong>
              </p>
            </li>
          </ol>
      ...
      <ol className="list-disc">
        ...
        <li>
          ...
          Each service's independent runtime increases resource usage and costs.
        </li>
      </ol>
    </div>
  );
