    ...
    <div className="md:mt-5 my-3 md:max-w-2xl md:ml-6">
      ...
      <ol className="list-disc ml-5">
        <li className="text-neutral-400">
          ...
          <strong className="text-neutral-200">competiton, grading or classes centrally</strong> with simple
          interfaces and provide some <strong className="text-neutral-200">scoring monitors</strong> for
          various sports to use in competitons.
        </li>
        <li className="text-neutral-400">Store and track and store the data of all events and payments.</li>
      </ol>
      ...
      <ol className="list-decimal ml-5">
        ...
        <li className="text-neutral-400">Making Karate grading and store the tudent details</li>
        <li className="text-neutral-400">
      ...
      <ol className="list-decimal ml-5">
        <li className="text-neutral-400">
          currently app is supporting only for Karate, That need to be extended
          to other sports as well.
        </li>
        <li className="text-neutral-400">
          Creting a Sports socila media to update there achievements and meet
          other sportsman like <strong className="text-neutral-200">linkedin</strong> for jobs.
        </li>
      </ol>
      ...
      <ol className="list-decimal ml-5">
        <li className="text-neutral-400">
          Hot use <strong className="text-neutral-200">CUBIT</strong> which is grate library for state
          management in flutter
        </li>
        <li className="text-neutral-400">firebase storage rather than the firestore and authentication</li>
        <li className="text-neutral-400">
          data loading strategies to minimize the processign power, cache memory
          and api callings.
        </li>
      </ol>
      {/*cv and git hub repo*/}
