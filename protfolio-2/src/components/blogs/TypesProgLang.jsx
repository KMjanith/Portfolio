...
export default function TypesProgLang() {
  return (
    <div className="md:mt-5 my-3 md:max-w-3xl md:ml-6">
      ...
      <div className="flex flex-wrap justify-center items-center gap-2 my-6 lg:my-10 border lg:py-6 py-2 border-neutral-800 rounded-3xl">
        <Images
      ...
      <ol className="list-disc ml-5">
        ...
        <li>
          Ideal for complex systems that need structured code and scalability.
        </li>
      </ol>

      <Topic content="3. Procedural Languages" />
      <p className="lg:text-lg text-neutral-400">
        <strong className="text-neutral-300">Follow a step-by-step execution flow,</strong> emphasizing
      ...
      <p className="lg:text-lg text-neutral-400">
        ...
        project’s needs. it depends <strong className="text-neutral-300">whether it’s automation, system-level programming, or
        complex, modular applications.</strong>  Understanding these categories ensures
        you select the most efficient tool for the job.
      </p>
    </div>
  );
}
